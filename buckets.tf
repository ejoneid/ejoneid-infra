resource "minio_s3_bucket" "ejoneid_print_flow_demo" {
  bucket         = "ejoneid-print-flow-demo"
  acl            = "private"
  object_locking = false
}

resource "minio_s3_bucket_cors" "print_flow_demo" {
  bucket = minio_s3_bucket.ejoneid_print_flow_demo.id
...
resource "minio_s3_bucket" "ejoneid_dokploy_backups" {
  bucket         = "ejoneid-dokploy-backups"
  acl            = "private"
  object_locking = false
}
